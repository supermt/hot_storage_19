...
%This can make full use of the system's read and write performance while introduces additional overheads for both storage and software-level layouts. The first problem is write amplification, 
